#!/usr/bin/env python3
"""
Verification Reminder Hook (Python/R projects)

Non-blocking reminder that fires on Write/Edit to source files (.py, .R)
to remind about running tests before marking a task as done.
...
VERIFY_EXTENSIONS = {
    ".py": "run tests / verify output",
    ".R": "run script / check regression output",
    ".r": "run script / check regression output",
}
