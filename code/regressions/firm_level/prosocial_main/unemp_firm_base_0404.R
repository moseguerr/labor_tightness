...
texreg(list(reg_1, reg_2, reg_3, reg_4, reg_5, reg_6, reg_7, reg_8, reg_9, reg_10), digits =4, file='/global/home/pc_moseguera/data/Burning Glass 2/Regression Tables/unemp_base_firm_mean.txt')
...
texreg(list(reg_1, reg_2, reg_3, reg_4, reg_5, reg_6, reg_7, reg_8, reg_9, reg_10), digits =4, file='/global/home/pc_moseguera/data/Burning Glass 2/Regression Tables/unemp_base_firm_main.txt')
