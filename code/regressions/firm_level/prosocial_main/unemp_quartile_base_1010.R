...
panel_main <- panel_main %>%
    ...
    unemp_quarter < unemp_quartiles$q25_unemp ~ 4,
    unemp_quarter >= unemp_quartiles$q25_unemp & unemp_quarter < unemp_quartiles$q50_unemp ~ 3,
    unemp_quarter >= unemp_quartiles$q50_unemp & unemp_quarter < unemp_quartiles$q75_unemp ~ 2,
    TRUE ~ 1))
...
texreg(list(reg_1, reg_3, reg_4, reg_5), digits = 4, file = '/global/home/pc_moseguera/data/Burning Glass 2/Regression Tables/firm_level/unemp_quartile_base_1010.txt')
