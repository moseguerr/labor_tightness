...
reg_1<-felm(log_sal ~ below25_unemp+main_strict_ind | as.factor(year)  | 0 | CanonEmployer, data=panel_main)
...
texreg(list(reg_1, reg_2, reg_3,reg_4), digits =4, file='/global/home/pc_moseguera/data/Burning Glass 2/Regression Tables/quarter/wages_main_strict_quarter_0313.txt')

reg_1<-felm(log_sal ~ below25_unemp+main_ind | as.factor(year)  | 0 | CanonEmployer, data=panel_main)
...
texreg(list(reg_1, reg_2, reg_3, reg_4), digits =4, file='/global/home/pc_moseguera/data/Burning Glass 2/Regression Tables/quarter/wages_main_quarter_0313.txt')


reg_1<-felm(log_sal ~ below25_unemp+main_mean_str | as.factor(year)  | 0 | CanonEmployer, data=panel_main)
...
texreg(list(reg_1, reg_2, reg_3,reg_4), digits =4, file='/global/home/pc_moseguera/data/Burning Glass 2/Regression Tables/quarter/wages_mean_strict_quarter_0313.txt')

reg_1<-felm(log_sal ~ below25_unemp+main_mean | as.factor(year)  | 0 | CanonEmployer, data=panel_main)
...
texreg(list(reg_1, reg_2, reg_3,reg_4), digits =4, file='/global/home/pc_moseguera/data/Burning Glass 2/Regression Tables/quarter/wages_mean_quarter_0313.txt')
