...
texreg(list(reg_1, reg_2, reg_3, reg_4), digits =4, file='/Volumes/TOSHIBA EXT/Second Year Paper/Regression Tables/job_level/secondary_analysis/occupation_growth/main_occ_msa.txt')

texreg(list( reg_5, reg_6, reg_7, reg_8), digits =4, file='/Volumes/TOSHIBA EXT/Second Year Paper/Regression Tables/job_level/secondary_analysis/occupation_growth/mean_occ_msa.txt')
