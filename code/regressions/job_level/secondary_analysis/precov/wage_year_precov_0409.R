...
texreg(list(reg_1, reg_2, reg_3, reg_4), digits =4, file='/Volumes/TOSHIBA EXT/Second Year Paper/Regression Tables/job_level/secondary_analysis/precov/wage_year_precov_0508.txt')
