...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb  4 11:25:32 2025
...
output_directory = '/global/home/pc_moseguera/data/Burning Glass 2/merged_variables/merge_main/2010'

#df = pd.read_table('/global/home/pc_moseguera/data/Burning Glass 2/CSV/US/Add/Main/2010/Main_2010-01.zip', encoding='latin')  # Use appropriate encoding
file='Main_2014-01.zip'

#directory='/global/home/pc_moseguera/data/other_data/'
directory='/Users/mgor/Dropbox/Second YPP/Data/Other data/'
df= pd.read_table('/Users/mgor/Dropbox/Second YPP/Data/Data Aux/' + file , delimiter=',', encoding='latin')
#1. First Clean
#########################
...
df_ind = pd.read_parquet(directory + 'Industry Employment/Processed/With Bartik/' + year + '.parquet')
...
skills_file_name = file.replace("Main", "Skills").replace(".zip", ".parquet")
# Construct the full file path
skills_file_path = os.path.join(output_directory, skills_file_name)
# Load the Parquet file
df_skills = pd.read_parquet('/Users/mgor/Library/CloudStorage/Dropbox/Second YPP/Data/Data Aux/'+ skills_file_name, engine='pyarrow')
...
#Text
# Generate the corresponding file name
txt_file_name = file.replace("Main", "Text").replace(".zip", ".parquet")
# Construct the full file path
txt_file_path = os.path.join(output_directory, txt_file_name)
# Load the Parquet file
df_txt = pd.read_parquet('/Users/mgor/Library/CloudStorage/Dropbox/Second YPP/Data/Data Aux/'+ txt_file_name, engine='pyarrow')
...
output_file_name = file.replace('.zip', '.parquet')
