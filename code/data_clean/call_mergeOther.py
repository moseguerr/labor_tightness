import os
from mergeOther import process_files_for_year

# Define directories
years = [str(year) for year in range(2010, 2011)]  # ✅ Sequential year processing
...
if __name__ == "__main__":
    for year in years:  # ✅ Process years sequentially (NO parallelization across years)
